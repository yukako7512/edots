...
<html lang="ja">
    <head>
        ...
        <!--<link rel="stylesheet" href="reviewdone.css">-->
         <link rel="stylesheet" href="{{ asset('css/reviewdone.css') }}">
    </head>
